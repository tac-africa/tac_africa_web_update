                ...
                <section id='contact' className=" w-10/12 lg:w-10/12 mx-auto py-20 lg:py-[120px] overflow-hidden relative z-10">
                    ...
                    <div className="container">
                        <div className="flex flex-wrap -mx-4">
                            ...
                            <div className="w-full lg:w-1/2 xl:w-6/12  ">
                                <div className="bg-white relative p-8 sm:p-12 shadow-lg h-[30rem] rounded-r-lg mr- 12 ">
                                    <form action="https://api.web3forms.com/submit" method="POST">
                                        ...
                                        <div className='flex'>
                                        <button type="submit" value="submit" className="text-white bg-blue-700 hover:bg-gradient-to-br  focus:outline-none  font-medium rounded-lg text-sm px-8 py-4 text-center mr-2">
                                            Send Message
                                        </button>
                                        </div>
                                    </form>
